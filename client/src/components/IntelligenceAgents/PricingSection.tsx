          ...
          <div className="p-6 sm:p-10 flex flex-col">
            ...
            <div className="mt-6">
              <div className="inline-flex items-center gap-1 rounded-2xl border border-white/10 bg-white/[0.05] p-1 ring-1 ring-white/10">
                ...
                >
                  BUNDLE <span className="text-[9px] bg-[#D4A574] text-[#2D1B10] px-1 rounded font-bold">SAVE 20%</span>
                </button>
              </div>
            </div>
              ...
              {keysToShow.map((key) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`inline-flex items-center justify-center h-9 w-9 rounded-full transition ${isActive ? 'bg-[#D4A574] text-[#2D1B10]' : 'bg-white/5 ring-1 ring-white/10 text-zinc-300 group-hover:bg-white/10'}`}>
